...
public final class SQLiteConnection: SQLiteDatabase, Sendable {
    ...
    private static func openInternal(
        ...
        var openOptions = readonlyMode ? SQLITE_OPEN_READONLY : SQLITE_OPEN_CREATE | SQLITE_OPEN_READWRITE
        openOptions |= SQLITE_OPEN_FULLMUTEX | SQLITE_OPEN_URI | SQLITE_OPEN_EXRESCODE
